...
class Station4AController extends Controller
{
    ...
    public function patientS4Create(Request $request){
        try{
           ...
           $Complaints = $request->Complaints['complain'];
           ...
           for($i=0;$i<count($Complaints); $i++){
                ...
                $Complaint->CreateDate  = $Complaints[$i]['CreateDate'];
                $Complaint->CreateUser  = $Complaints[$i]['CreateUser'];
                $Complaint->UpdateDate  = $Complaints[$i]['UpdateDate'];
           ...
           for($i=0;$i<count($PresentIllness); $i++){
            ...
            //Save Past illness
            $PastIllness = $request->PatientHOPastIllness['PastIllnesses'];
            ...
            //Save Family illness
            $FamilyIllness = $request->PatientHOFamilyIllness['PastIllnesses'];
            ...
            $SocialHistory = $request->SocialHistory['Social'];
            ...
            //Save TB Screening
            $TBScreening = $request->TBScreening['screening'];
            ...
            $GeneralExamination = $request->GeneralExamination['examination'];
            ...
            $SystemicExam = $request->SystemicExamination['SystemicExam'];
            ...
            $MedicationTaken = $request->CurrentMedicationTaken['MedicationTaken'];
            ...
            $MentalHealth = $request->PatientMentalHealth['MentalHealth'];
            ...
            $ChildVaccination = $request->ChildVaccination['ChildVaccination'];
            ...
            $AdultVaccination = $request->AdultVaccination['AdultVaccination'];
