...
//Station 4B route start
   ...
   Route::get('patient-s4b-during-menstruation','Station4BController@patientS4bDuringMenstruation'); // get What Product You Use Durina The Menstruation
...
Route::post('provisional-diagonisis','Station4BController@provisionalDiagonisis');
